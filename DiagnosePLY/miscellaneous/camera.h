...
class Frame {
 public:
  ...
  inline Frame(const Eigen::Vector3f& pos = Eigen::Vector3f::Zero(), const Eigen::Quaternionf& o = Eigen::Quaternionf(1.0f, 0.0f, 0.0f, 0.0f))
...
class Camera {
 public:
  ...
  inline int vpX(void) const { return mVpX; }
  inline int vpY(void) const { return mVpY; }
  inline int vpWidth(void) const { return mVpWidth; }
  inline int vpHeight(void) const { return mVpHeight; }
  // Additional Functions
  inline float nearDist(void) const { return mNearDist; }
  inline float farDist(void) const { return mFarDist; }
